...
public class InterfazOnline extends AppCompatActivity {
    ...
    String urlServer = "192.168.115.63";
    RequestQueue queue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interfaz_online);
        mostrarPartidas();
    ...
    private void crearJuego(){
        ...
        StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast toast1 = Toast.makeText(getApplicationContext(), "Error al crear", Toast.LENGTH_SHORT);
    ...
    private void mostrarPartidas(){
        ...
        StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast toast1 = Toast.makeText(getApplicationContext(), "No", Toast.LENGTH_SHORT);
    ...
    public void listar(ArrayList<String> partida){
        ...
        ArrayAdapter adapter = new ArrayAdapter(this, android.R.layout.simple_list_item_1, partida);

        partidas = findViewById(R.id.listaPartidas);

        partidas.setAdapter(adapter);
    }

    private AdapterView.OnItemClickListener MessageClickedHandler = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView parent, View v, int position, long id) {
            partidas.setBackgroundColor(Color.YELLOW);
        }
    };
...
public class Listar extends AppCompatActivity {
    ...
    private void crearJuego(){
        final RequestQueue queue = Volley.newRequestQueue(this);
        String url = "http://192.168.1.8/conecta4/start.php";
        StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
    ...
    private void mostrarPartidas(){
        ...
        final RequestQueue queue = Volley.newRequestQueue(this);
        String url = "http://192.168.1.8/conecta4/game.php";
        StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
